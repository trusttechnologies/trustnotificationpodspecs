...
s.source = { :git => "https://github.com/trusttechnologies/lat_trust_mobile_ios_trust-notification_library.git", 
             :tag => "#{s.version}" }
...
s.resources = "TrustNotification/**/*.{png,jpeg,jpg,storyboard,xib,xcassets}"
